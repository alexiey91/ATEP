...
\end{equation}
ma la (\ref{eq:quota_issh}) \underline{non} deve pagata interamente dal dipendente, che dovrà pagare solamente:
\begin{equation}
...
\subsection[Calcolo Contributi Singolo Dipendente]{Calcolo Contributi Singolo Dipendente}
