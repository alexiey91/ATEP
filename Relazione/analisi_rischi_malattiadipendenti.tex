...
\begin{comment}
Tenendo conto i giorni lavorativi mensili pari a:
  
\begin{savenotes}
\begin{table}[htb]
\centering
 \caption{Giorni Lavoro}
 \begin{tabular}{p{5cm}D{,}{,}{5.2}D{,}{,}{5.2}}
 \toprule
 	& \multicolumn{1}{c}{\textbf{Annuali}} & \multicolumn{1}{c}{\textbf{Mensili}} \\
 \midrule 	
	\makebox[5cm][r]{Giorni lavorativi} & 222,00 & 18,50\\
 \bottomrule
 \end{tabular} 
\end{table}
\end{savenotes}
...
\subsection[Caso Migliore - Mese Dicembre]{Caso Migliore - Mese Dicembre} 
...
\subsection[Caso Peggiore - Mese di Gennaio]{Caso Peggiore - Mese di Gennaio}
