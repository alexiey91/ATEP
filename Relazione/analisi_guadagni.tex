...
Possiamo stimare che in una giornata un centralinista è in grado di effettuare un numero di chiamate pari a:
	...
	\begin{split}
		\frac{60}{3,5} * 5,5 = 94,27 \simeq 94 
	\end{split}
	\end{equation}
...
\item il \textbf{numero medio contratti stipulati in un anno}
	...
	\begin{split}
		624040 * 0,1560 = 97350,24
	\end{split}
	\end{equation}
\item il \textbf{fatturato annuale netto (\euro)}
	\begin{equation}
	\label{eq:fatturato_anno_netto}
	\begin{split}
		97350,24 * 80,00 = 7788019,20 
	\end{split}
	\end{equation}
\item il \textbf{fatturato mensile netto (\euro)} 
	\begin{equation}
	\label{eq:fatturato_mensile_netto}
	\begin{split}
		\frac{7788019,20}{12} = 649001,60 
	\end{split}
	\end{equation}
\end{itemize}