...
\centering
 ...
 \midrule 		
	\makebox[3cm][c]{2012} & 19,20 \cite{Istat2012}\\
 	\makebox[3cm][c]{2013} & 18,10 \cite{Istat2013}\\
 	\makebox[3cm][c]{2014} & 16,38 \cite{Istat2014}\\  	
 	\makebox[3cm][c]{2015} & 16,50 \cite{Istat2015}\\
 \bottomrule
 \end{tabular} 
\end{table}
\end{savenotes}
...
per ottenere il valore relativo all'anno 2016 è stata calcolata, utilizzando il servizio Web \textit{Wolfram Alpha}, la \textit{funzione di regressione} sui dati precedenti:
\newline
	\begin{equation}
